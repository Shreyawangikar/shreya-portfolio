...
const cardData = [
  ...
  },
  {
    ...
    description: '2x finalist with innovative solutions',
    label: 'Achievement',
    icon: Rocket,
  },
  {
    ...
    description: 'Effective communication & agile workflows',
    label: 'Soft Skill',
    icon: Users,
  },
  {
    color: 'hsl(222, 36%, 11%)',
    title: 'Clean Code',
    description: 'Writing maintainable & documented code',
    label: 'Practice',
    icon: GitBranch,
  },
  {
      ...
      <style>
        {`
          .bento-section {
            ...
            --background-dark: hsl(222, 36%, 11%);
            --white: hsl(220, 32%, 93%);
            --primary: hsl(225, 100%, 65%);
            --primary-glow: rgba(76, 131, 255, 0.2);
            --primary-border: rgba(76, 131, 255, 0.8);
          }
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-4">
          {cardData.map((card, index) => {
            ...
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[180px] w-full max-w-full p-5 rounded-xl border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg ${
              ...
              return (
                ...
                >
                  <div className="card__header flex justify-between items-start gap-3 relative">
                    <span className="card__label text-xs font-mono text-primary uppercase tracking-wider">{card.label}</span>
                    <Icon size={20} className="text-primary/60" />
                  </div>
                  <div className="card__content flex flex-col relative mt-auto">
                    <h3 className={`card__title font-semibold text-base m-0 mb-1.5 text-foreground ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.title}
                    </h3>
                    <p
            ...
            return (
              ...
              >
                ...
                <div className="card__content flex flex-col relative mt-auto">
                  ...
                  <p className={`card__description text-sm leading-relaxed text-muted-foreground ${textAutoHide ? 'text-clamp-2' : ''}`}>
                    {card.description}
                  </p>
                </div>
              </motion.div>
