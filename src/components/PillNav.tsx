...
const PillNav = ({
  ...
  className = '',
  ease = 'power3.easeOut',
  baseColor = 'hsl(220, 32%, 93%)',
  pillColor = 'hsl(222, 36%, 11%)',
  hoveredPillTextColor = 'hsl(220, 32%, 93%)',
  pillTextColor,
  onMobileMenuClick,
  ...
  return (
    <div className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden fixed top-[4rem] left-4 right-4 rounded-[27px] shadow-lg z-[998] origin-top"
        style={{
          ...cssVars,
          background: 'var(--base)'
        }}
          ...
          {items.map(item => {
            ...
            return (
              <li key={item.href}>
                <a
                  href={item.href}
                  className="block py-3 px-4 text-[14px] font-medium rounded-[50px] transition-all duration-200 hover:bg-[var(--base)] hover:text-[var(--hover-text)]"
                  style={defaultStyle}
